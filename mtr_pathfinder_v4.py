...
def run():
    ...
    main(station1=station1, station2=station2, LINK=LINK, LOCAL_FILE_PATH=LOCAL_FILE_PATH, DEP_PATH=DEP_PATH,
         ...
         ORIGINAL_IGNORED_LINES=ORIGINAL_IGNORED_LINES, ROUTE_MAPPING=ROUTE_MAPPING, UPDATE_DATA=UPDATE_DATA, GEN_DEPARTURE=GEN_DEPARTURE,
         ...
         CALCULATE_BOAT=CALCULATE_BOAT, CALCULATE_WALKING_WILD=CALCULATE_WALKING_WILD, ONLY_LRT=ONLY_LRT, DETAIL=DETAIL, MAX_HOUR=MAX_HOUR,
